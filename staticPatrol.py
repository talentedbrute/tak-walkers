...
# walker_type = "a-f-S-X-L"   # CIVILIAN LAW ENFORCMENT SHIP
walker_type = "a-f-G-U-U-L" # LAW ENFORCEMENT
...
walker_points = [[33.98361, -118.32646],
                 [33.98063, -118.32651],
                 [33.98066, -118.32789],
                 [33.98297, -118.32792]]
...
def main():
    ...
    for k in range(num_walkers):
        ...
        callsigns.append("%s-%s" % (callsign, letters[k]))
